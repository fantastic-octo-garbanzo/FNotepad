...
/******************************************************/
public class FontChooserIT extends JPanel /*implements ActionListener*/ {
    ...
    public FontChooserIT(Font withFont) {
        thisFont=withFont;
        ...
        okButton.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent ev) {
                        ok=true;
                        FontChooserIT.this.thisFont=FontChooserIT.this.createFont();
