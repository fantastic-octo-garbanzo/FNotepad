...
public class FNotepadLANG implements ActionListener {
    ...
    /****************************/
    public FNotepadLANG(boolean fullscreen, Locale startLanguage) {
...
////////////////////////////////////
            ...
            if (FNotepadLANG.this.ta.getText().length() == 0)
                return;    // text box have no text
            if (findReplaceDialog == null)
                findReplaceDialog = new FindDialogLANG(FNotepadLANG.this.ta);
            findReplaceDialog.showDialog(FNotepadLANG.this.f, true);//find
        }
////////////////////////////////////
...
////////////////////////////////////
            ...
            if (findReplaceDialog == null)
                findReplaceDialog = new FindDialogLANG(FNotepadLANG.this.ta);
            findReplaceDialog.showDialog(FNotepadLANG.this.f, false);//replace
        }
////////////////////////////////////
...
////////////////////////////////////
            ...
            if (fontDialog.showDialog(FNotepadLANG.this.f, bundle.getString("font.text1")))
                FNotepadLANG.this.ta.setFont(fontDialog.createFont());
        }
////////////////////////////////////
...
////////////////////////////////////
            ...
            JOptionPane.showMessageDialog(FNotepadLANG.this.f, bundle.getString("aboutText"), bundle.getString("about.text1"), JOptionPane.INFORMATION_MESSAGE);
        }
////////////////////////////////////
...
////////////////////////////////////
                    ...
                    (FNotepadLANG.this.f,
                            ...
                            new ActionListener() {
                                public void actionPerformed(ActionEvent evvv) {
                                    FNotepadLANG.this.ta.setBackground(bcolorChooser.getColor());
                                }
                            }, null);
        ...
        if (foregroundDialog == null)
            foregroundDialog = JColorChooser.createDialog
                    (FNotepadLANG.this.f,
                            ...
                            new ActionListener() {
                                public void actionPerformed(ActionEvent evvv) {
                                    FNotepadLANG.this.ta.setForeground(fcolorChooser.getColor());
                                }
                            },
                            null);
    ...
    void changeLanguage1() {
        ...
        if (locale == Locale.ENGLISH){
            new FNotepadLANG(true, Locale.GERMAN);
        }
        if (locale == Locale.GERMAN){
            new FNotepadLANG(true, Locale.ENGLISH);
        }
    ...
    void changeLanguage2() {
        ...
        if (locale == Locale.ENGLISH){
            new FNotepadLANG(true, Locale.ITALIAN);
        }
        if (locale == Locale.GERMAN){
            new FNotepadLANG(true, Locale.ITALIAN);
        }
...
/************For Look and Feel, May not work properly on different operating environment***/
        ...
        MenuListener editMenuListener = new MenuListener() {
            public void menuSelected(MenuEvent evvvv) {
                ...
                if (FNotepadLANG.this.ta.getSelectionStart() == ta.getSelectionEnd()) {
