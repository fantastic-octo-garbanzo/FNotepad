...
/******************************************************/
public class FindDialog extends JPanel implements ActionListener, MenuConstants {
	JTextArea jta;
	...
	public FindDialog(JTextArea jta) {
		...
		matchCase = new JCheckBox(matchCaseVar);

		up = new JRadioButton(MenuConstants.up);
		down = new JRadioButton(MenuConstants.down);
		...
		Border titled = BorderFactory.createTitledBorder(etched,MenuConstants.direction);
		...
		findNextButton = new JButton(findText);
